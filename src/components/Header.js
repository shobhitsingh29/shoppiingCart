        ...
        return (
            <header>
                <div className="container">
                    <div className="brand">
                        <div className="heading-logo"> CURATED.</div>
                    </div>
                    ...
                    <div className="search">
                        ...
                        <form action="#" method="get"
                            ...
                            <a className="back-button" href="#" onClick={this.handleSearchNav.bind(this)}><img
                                ...
                                alt="back"/></a>
                            <input type="search" ref="searchBox" placeholder="Search products here"
                                   className="search-keyword" onChange={this.props.handleSearch}/>
                    ...
                    <div className="cart">
                        ...
                        <Link to={{
                            pathname: 'cartpreview',
                            query: {items: this.props.cartItems, total: this.props.total}
                        }}>
